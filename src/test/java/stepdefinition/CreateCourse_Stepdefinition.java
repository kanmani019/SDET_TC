...
public class CreateCourse_Stepdefinition {
	...
	public void enter_valid_credential_in_code_textbox() throws Throwable {
		driver.findElement(By.name("visual_code")).sendKeys("tes");
	...
	public void select_Valid_credentials_from_Category_list_box() throws Throwable {
		...
		driver.findElement(By.xpath("//input[@role=\"textbox\"]")).sendKeys("Projects");
		act.click().perform();
	...
	public void select_Valid_credentials_in_Teacher_list_box() throws Throwable {
		Actions act = new Actions(driver);
		driver.findElement(By.xpath("//input[@class=\"select2-search__field\"]")).sendKeys("manzoor");
		Thread.sleep(7000);
		act.click().perform();
	
		//Select sel = new Select (driver.findElement(By.xpath("//input[@class=\"select2-search__field\"]")));
		//sel.selectByValue("1manzoor mehadi(2manzoor)");
	...
	@Then("^Click on Create a course button$")
